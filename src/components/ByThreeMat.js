...
import ByThreeMatJson from "../json/ByThreeMat";

const mat = ByThreeMatJson;
...
export default class byThreeMat extends React.Component {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    return (
      <View style={{ flex: 1, backgroundColor: "#333" }}>
        ...
        >
          {/* <Text style={{ height: 300, fontSize: 100, backgroundColor: "red"}}>[</Text> */}
          {/* <View> */}
            <TouchableOpacity
              onPress={() => {
